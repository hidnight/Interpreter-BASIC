...
namespace BASIC_Interpreter_Library {
    static class Constants {
        ...
        public static readonly Interpreter_symbol[][] RULE = new Interpreter_symbol[59][] {
            ...
            /*11 SYM_DECLARATION_LIST  */new Interpreter_symbol[]{ TOK_ID, TOK_AS, SYM_TYPE, SYM_DECLARATION_LIST_, TOK_EOT },
            /*12 SYM_DECLARATION_LIST_ */new Interpreter_symbol[]{ TOK_COMMA, TOK_ID, TOK_AS, SYM_TYPE, SYM_DECLARATION_LIST_, TOK_EOT },
            ...
            /*15 SYM_ASSIGNMENT_       */new Interpreter_symbol[]{ TOK_ASS, SYM_EXPRESSION, TOK_LF, TOK_EOT },
            /*16 SYM_ASSIGNMENT_       */new Interpreter_symbol[]{ TOK_LB, SYM_EXPRESSION, TOK_RB, TOK_ASS, SYM_EXPRESSION, TOK_LF, TOK_EOT },
            /*17 SYM_BOOLEAN           */new Interpreter_symbol[]{ TOK_IF, SYM_EXPRESSION, TOK_THEN, TOK_LF, SYM_MODULE, SYM_BOOLEAN_END, TOK_EOT },
            /*18 SYM_BOOLEAN_END       */new Interpreter_symbol[]{ TOK_ELSE, TOK_LF, SYM_MODULE, TOK_END_IF, TOK_LF, TOK_EOT },
            /*19 SYM_BOOLEAN_END       */new Interpreter_symbol[]{ TOK_END_IF, TOK_LF, TOK_EOT },
            /*20 SYM_PRINT             */new Interpreter_symbol[]{ TOK_PRINT, SYM_EXPRESSION, TOK_LF, TOK_EOT },
            /*21 SYM_WHILE             */new Interpreter_symbol[]{ TOK_WHILE, SYM_EXPRESSION, TOK_LF, SYM_MODULE, TOK_END_WHILE, TOK_LF, TOK_EOT },
            /*22 SYM_EMPTY             */new Interpreter_symbol[]{ TOK_LF, TOK_EOT },
            /*23 SYM_TYPE              */new Interpreter_symbol[]{ TOK_STRING, TOK_EOT },
            /*24 SYM_TYPE              */new Interpreter_symbol[]{ TOK_LONG, TOK_EOT },
            /*25 SYM_TYPE              */new Interpreter_symbol[]{ TOK_REAL, TOK_EOT },
            /*26 SYM_EXPRESSION        */new Interpreter_symbol[]{ SYM_LOGICAL_AND, SYM_LOGICAL_AND_, TOK_EOT },
            /*27 SYM_LOGICAL_AND_      */new Interpreter_symbol[]{ TOK_OR, SYM_LOGICAL_AND, SYM_LOGICAL_AND_, TOK_EOT },
            ...
            /*30 SYM_LOGICAL_NOT_      */new Interpreter_symbol[]{ TOK_AND, SYM_LOGICAL_NOT, SYM_LOGICAL_NOT_, TOK_EOT },
            /*31 SYM_LOGICAL_NOT_      */new Interpreter_symbol[]{ TOK_EOT },
            /*32 SYM_LOGICAL_NOT       */new Interpreter_symbol[]{ TOK_NOT, SYM_LOGICAL_NOT, TOK_EOT },
            /*33 SYM_LOGICAL_NOT       */new Interpreter_symbol[]{ SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*34 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_EQ, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*35 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_NE, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*36 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_LT, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*37 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_GT, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*38 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_LE, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*39 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_GE, SYM_RELATION, SYM_RELATION_, TOK_EOT },
            /*40 SYM_RELATION_         */new Interpreter_symbol[]{ TOK_EOT },
            /*41 SYM_RELATION          */new Interpreter_symbol[]{ SYM_TERM, SYM_TERM_, TOK_EOT },
            /*42 SYM_TERM_             */new Interpreter_symbol[]{ TOK_ADD, SYM_TERM, SYM_TERM_, TOK_EOT },
            /*43 SYM_TERM_             */new Interpreter_symbol[]{ TOK_SUB, SYM_TERM, SYM_TERM_, TOK_EOT },
            /*44 SYM_TERM_             */new Interpreter_symbol[]{ TOK_EOT },
            /*45 SYM_TERM              */new Interpreter_symbol[]{ SYM_UNARY, SYM_UNARY_, TOK_EOT },
            /*46 SYM_UNARY_            */new Interpreter_symbol[]{ TOK_MUL, SYM_UNARY, SYM_UNARY_, TOK_EOT },
            /*47 SYM_UNARY_            */new Interpreter_symbol[]{ TOK_DIV, SYM_UNARY, SYM_UNARY_, TOK_EOT },
            /*48 SYM_UNARY_            */new Interpreter_symbol[]{ TOK_EOT },
            /*49 SYM_UNARY             */new Interpreter_symbol[]{ SYM_PRIMITIVE, TOK_EOT },
            /*50 SYM_UNARY             */new Interpreter_symbol[]{ TOK_SUB, SYM_PRIMITIVE, TOK_EOT },
            /*51 SYM_UNARY             */new Interpreter_symbol[]{ TOK_ADD, SYM_PRIMITIVE, TOK_EOT },
            /*52 SYM_PRIMITIVE         */new Interpreter_symbol[]{ TOK_ID, SYM_PRIMITIVE_, TOK_EOT },
            /*53 SYM_PRIMITIVE         */new Interpreter_symbol[]{ TOK_I4, TOK_EOT },
            /*54 SYM_PRIMITIVE         */new Interpreter_symbol[]{ TOK_R8, TOK_EOT },
            /*55 SYM_PRIMITIVE         */new Interpreter_symbol[]{ TOK_QUOTE, TOK_EOT },
            /*56 SYM_PRIMITIVE         */new Interpreter_symbol[]{ TOK_LP, SYM_EXPRESSION, TOK_RP, TOK_EOT },
            /*57 SYM_PRIMITIVE_        */new Interpreter_symbol[]{ TOK_LB, SYM_EXPRESSION, TOK_RB, TOK_EOT },
            /*58 SYM_PRIMITIVE_        */new Interpreter_symbol[]{ TOK_EOT }
        };
        /* Max rule index */
